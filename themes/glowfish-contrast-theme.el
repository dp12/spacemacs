...
'(mode-line ((((class color) (min-colors 88)) (:foreground "#95cc5e" :background "#3a3a3a" :box (:line-width -1 :color "#35393b" :style unspecified))) (t (:inverse-video unspecified))))
'(mode-line-inactive ((((class color) (min-colors 88)) (:foreground "#f8f8f0" :background "#3a3a3a" :box (:line-width -1 :color "#35393b" :style unspecified))) (t (:inverse-video unspecified))))
